...
class TestGetSupabaseClient:
    ...
    def test_get_supabase_client_initialization(self, mock_get_settings, mock_create_client):
    ...
    @patch('src.db.client.create_client')
    @patch('src.db.client.get_settings')
    def test_get_supabase_client_uses_settings(self, mock_get_settings, mock_create_client):
